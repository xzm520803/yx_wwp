...
<head>
    ...
    <script>
            ...
            function chgImg(){
                //获取验证码图片对象
                var imgObj = document.getElementById("clientCode");
                //修改验证码src的属性，换一张
                imgObj.src="${pageContext.request.contextPath }/admin/img?xx="+Math.random();
            }
            $(function(){
            //提交表单
                    ...
                    <div class="form-bottom" style="width: 450px">
                        ...
                        <form role="form" action="${pageContext.request.contextPath}/admin/login" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <img id="clientCode" style="height: 48px" class="captchaImage" src="${path}/admin/img">
                                <a href="javascript:;" onclick="chgImg()">换一张</a>
                                <input minlength="4" style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required type="test" name="clientCode" id="form-code">
                            </div>
